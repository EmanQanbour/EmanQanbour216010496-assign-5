...
while ($result = mysqli_fetch_assoc($data )) {
  ...
  <tr>
    ...
    <td>". $result["pass"]."</td>
    <td>
      <a href='editsign.php?id_reg= $result[id_reg]'><input type ='submit' value='edit'></a></td>
     <td> <a href='deletesign.php?id_reg= $result[id_reg]'><input type ='submit' value='delete'></a>
